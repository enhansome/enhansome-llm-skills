...
* [Taisly Agent Kit](https://github.com/taisly/agent) ⭐ 213 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-06 - Publishes approved short-form videos through Taisly with a reusable Agent Skill, Codex plugin, CLI, and remote MCP server.
...
* [docx](https://github.com/anthropics/skills/tree/main/document-skills/docx) ⭐ 177,809 | 🐛 1,270 | 🌐 Python | 📅 2026-09-22 - Create, edit, analyze Word docs with tracked changes, comments, formatting.
* [pdf](https://github.com/anthropics/skills/tree/main/document-skills/pdf) ⭐ 177,809 | 🐛 1,270 | 🌐 Python | 📅 2026-09-22 - Extract text, tables, metadata, merge & annotate PDFs.
* [pptx](https://github.com/anthropics/skills/tree/main/document-skills/pptx) ⭐ 177,809 | 🐛 1,270 | 🌐 Python | 📅 2026-09-22 - Read, generate, and adjust slides, layouts, templates.
* [xlsx](https://github.com/anthropics/skills/tree/main/document-skills/xlsx) ⭐ 177,809 | 🐛 1,270 | 🌐 Python | 📅 2026-09-22 - Spreadsheet manipulation: formulas, charts, data transformations.
...
* [finishing-a-development-branch](https://github.com/obra/superpowers/tree/main/skills/finishing-a-development-branch) ⭐ 290,606 | 🐛 398 | 🌐 Shell | 📅 2026-09-22 - Guides completion of development work by presenting clear options and handling chosen workflow.
* [test-driven-development](https://github.com/obra/superpowers/tree/main/skills/test-driven-development) ⭐ 290,606 | 🐛 398 | 🌐 Shell | 📅 2026-09-22 - Use when implementing any feature or bugfix, before writing implementation code.
* [using-git-worktrees](https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/) ⭐ 290,606 | 🐛 398 | 🌐 Shell | 📅 2026-09-22 - Creates isolated git worktrees with smart directory selection and safety verification.
* [artifacts-builder](https://github.com/anthropics/skills/tree/main/artifacts-builder) ⭐ 177,809 | 🐛 1,270 | 🌐 Python | 📅 2026-09-22 - Suite of tools for creating elaborate, multi-component claude.ai HTML artifacts using modern frontend web technologies (React, Tailwind CSS, shadcn/ui).
* [Skill Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) ⭐ 15,022 | 🐛 46 | 🌐 Python | 📅 2026-09-20 - Automatically converts any documentation website into a Claude AI skill in minutes. *By [@yusufkaraaslan](https://github.com/yusufkaraaslan)*
* [Playwright Browser Automation](https://github.com/lackeyjb/playwright-skill) ⭐ 3,141 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-14 - Model-invoked Playwright automation for testing and validating web applications. *By [@lackeyjb](https://github.com/lackeyjb)*
* [iOS Simulator](https://github.com/conorluddy/ios-simulator-skill) ⭐ 1,259 | 🐛 20 | 🌐 Python | 📅 2026-09-13 - Enables Claude to interact with iOS Simulator for testing and debugging iOS applications. *By [@conorluddy](https://github.com/conorluddy)*
...
* [root-cause-tracing](https://github.com/obra/superpowers/tree/main/skills/root-cause-tracing) ⭐ 290,606 | 🐛 398 | 🌐 Shell | 📅 2026-09-22 - Use when errors occur deep in execution and you need to trace back to find the original trigger.
...
* [brainstorming](https://github.com/obra/superpowers/tree/main/skills/brainstorming) ⭐ 290,606 | 🐛 398 | 🌐 Shell | 📅 2026-09-22 - Transform rough ideas into fully-formed designs through structured questioning and alternative exploration.
...
* [git-pushing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/git-pushing) ⭐ 677 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Automate git operations and repository interactions.
* [review-implementing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/review-implementing) ⭐ 677 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Evaluate code implementation plans and align with specs.
* [test-fixing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/test-fixing) ⭐ 677 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Detect failing tests and propose patches or fixes.

### Security & Systems

* [computer-forensics](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/computer-forensics) ⭐ 677 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Digital forensics analysis and investigation techniques.
* [file-deletion](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/file-deletion) ⭐ 677 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Secure file deletion and data sanitization methods.
* [metadata-extraction](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/metadata-extraction) ⭐ 677 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Extract and analyze file metadata for forensic purposes.
...
* [dev-gtm-claude-skills](https://github.com/Infrasity-Labs/dev-gtm-claude-skills) ⭐ 126 | 🐛 0 | 🌐 Python | 📅 2026-06-28 - Open-source, cross-platform agent skills for Claude Code and agentskills.io-compatible platforms. These skills are for SEO, GEO (Generative Engine Optimization), AI discoverability, and developer marketing.
...
* [Anthropic Skills Repository](https://github.com/anthropics/skills) ⭐ 177,809 | 🐛 1,270 | 🌐 Python | 📅 2026-09-22 - Official example skills
