...
* [Taisly Agent Kit](https://github.com/taisly/agent) ⭐ 215 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-06 - Publishes approved short-form videos through Taisly with a reusable Agent Skill, Codex plugin, CLI, and remote MCP server.
...
* [docx](https://github.com/anthropics/skills/tree/main/document-skills/docx) ⭐ 178,537 | 🐛 1,330 | 🌐 Python | 📅 2026-09-24 - Create, edit, analyze Word docs with tracked changes, comments, formatting.
* [pdf](https://github.com/anthropics/skills/tree/main/document-skills/pdf) ⭐ 178,537 | 🐛 1,330 | 🌐 Python | 📅 2026-09-24 - Extract text, tables, metadata, merge & annotate PDFs.
* [pptx](https://github.com/anthropics/skills/tree/main/document-skills/pptx) ⭐ 178,537 | 🐛 1,330 | 🌐 Python | 📅 2026-09-24 - Read, generate, and adjust slides, layouts, templates.
* [xlsx](https://github.com/anthropics/skills/tree/main/document-skills/xlsx) ⭐ 178,537 | 🐛 1,330 | 🌐 Python | 📅 2026-09-24 - Spreadsheet manipulation: formulas, charts, data transformations.
* [Markdown to EPUB Converter](https://github.com/smerchek/claude-epub-skill) ⭐ 163 | 🐛 2 | 🌐 Python | 📅 2025-10-18 - Converts markdown documents and chat summaries into professional EPUB ebook files. *By [@smerchek](https://github.com/smerchek)*

### Development & Code Tools

* [finishing-a-development-branch](https://github.com/obra/superpowers/tree/main/skills/finishing-a-development-branch) ⭐ 291,916 | 🐛 399 | 🌐 Shell | 📅 2026-09-26 - Guides completion of development work by presenting clear options and handling chosen workflow.
* [test-driven-development](https://github.com/obra/superpowers/tree/main/skills/test-driven-development) ⭐ 291,916 | 🐛 399 | 🌐 Shell | 📅 2026-09-26 - Use when implementing any feature or bugfix, before writing implementation code.
* [using-git-worktrees](https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/) ⭐ 291,916 | 🐛 399 | 🌐 Shell | 📅 2026-09-26 - Creates isolated git worktrees with smart directory selection and safety verification.
* [artifacts-builder](https://github.com/anthropics/skills/tree/main/artifacts-builder) ⭐ 178,537 | 🐛 1,330 | 🌐 Python | 📅 2026-09-24 - Suite of tools for creating elaborate, multi-component claude.ai HTML artifacts using modern frontend web technologies (React, Tailwind CSS, shadcn/ui).
* [Skill Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) ⭐ 15,037 | 🐛 47 | 🌐 Python | 📅 2026-09-20 - Automatically converts any documentation website into a Claude AI skill in minutes. *By [@yusufkaraaslan](https://github.com/yusufkaraaslan)*
* [Playwright Browser Automation](https://github.com/lackeyjb/playwright-skill) ⭐ 3,150 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-14 - Model-invoked Playwright automation for testing and validating web applications. *By [@lackeyjb](https://github.com/lackeyjb)*
* [iOS Simulator](https://github.com/conorluddy/ios-simulator-skill) ⭐ 1,261 | 🐛 20 | 🌐 Python | 📅 2026-09-13 - Enables Claude to interact with iOS Simulator for testing and debugging iOS applications. *By [@conorluddy](https://github.com/conorluddy)*
* [Blueprint](https://github.com/JuliusBrussee/blueprint) ⭐ 1,150 | 🐛 18 | 📅 2026-08-14 - A Claude Code plugin for specification-driven development that turns natural language into blueprints, blueprints into parallel build plans, and build plans into working software with automated iteration and dual-model adversarial review. *By [@JuliusBrussee](https://github.com/JuliusBrussee)*
...
* [pypict-claude-skill](https://github.com/omkamal/pypict-claude-skill) ⭐ 98 | 🐛 0 | 🌐 Python | 📅 2026-03-22 - Design comprehensive test cases using PICT (Pairwise Independent Combinatorial Testing) for requirements or code, generating optimized test suites with pairwise coverage.
* [skill-optimizer](https://github.com/fastxyz/skill-optimizer) ⭐ 81 | 🐛 15 | 🌐 TypeScript | 📅 2026-05-28 - CLI tool that benchmarks SDK, CLI, and MCP guidance docs across multiple LLMs using static action and argument matching. Measures whether models call the right tools with correct arguments. Iteratively rewrites docs until every configured model meets a PASS/FAIL score floor. CI-friendly, MIT licensed.
* [codebase-recon](https://github.com/yujiachen-y/codebase-recon-skill) ⭐ 41 | 🐛 2 | 📅 2026-04-26 - Analyzes git history to reveal codebase hotspots, bug magnets, bus factor risks, team momentum, and development patterns before reading any code. *By [@yujiachen-y](https://github.com/yujiachen-y)*
...
* [root-cause-tracing](https://github.com/obra/superpowers/tree/main/skills/root-cause-tracing) ⭐ 291,916 | 🐛 399 | 🌐 Shell | 📅 2026-09-26 - Use when errors occur deep in execution and you need to trace back to find the original trigger.
...
* [postgres](https://github.com/sanjay3290/ai-skills/tree/main/skills/postgres) ⭐ 426 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - Execute safe read-only SQL queries against PostgreSQL databases with multi-connection support and defense-in-depth security. *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [brainstorming](https://github.com/obra/superpowers/tree/main/skills/brainstorming) ⭐ 291,916 | 🐛 399 | 🌐 Shell | 📅 2026-09-26 - Transform rough ideas into fully-formed designs through structured questioning and alternative exploration.
...
* [article-extractor](https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/article-extractor) ⭐ 550 | 🐛 3 | 🌐 Shell | 📅 2026-03-11 - Extract full article text and metadata from web pages.
* [family-history-research](https://github.com/emaynard/claude-family-history-research-skill) ⭐ 114 | 🐛 0 | 📅 2026-07-18 - Provides assistance with planning family history and genealogy research projects.
* [Content Research Writer](./content-research-writer/) - Assists in writing high-quality content by conducting research, adding citations, improving hooks, and providing section-by-section feedback.
* [Meeting Insights Analyzer](./meeting-insights-analyzer/) - Analyzes meeting transcripts to uncover behavioral patterns including conflict avoidance, speaking ratios, filler words, and leadership style.

### Creative & Media

* [youtube-transcript](https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/youtube-transcript) ⭐ 550 | 🐛 3 | 🌐 Shell | 📅 2026-03-11 - Fetch transcripts from YouTube videos and prepare summaries.
* [imagen](https://github.com/sanjay3290/ai-skills/tree/main/skills/imagen) ⭐ 426 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - Generate images using Google Gemini's image generation API for UI mockups, icons, illustrations, and visual assets. *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [ship-learn-next](https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/ship-learn-next) ⭐ 550 | 🐛 3 | 🌐 Shell | 📅 2026-03-11 - Skill to help iterate on what to build or learn next, based on feedback loops.
* [tapestry](https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/tapestry) ⭐ 550 | 🐛 3 | 🌐 Shell | 📅 2026-03-11 - Interlink and summarize related documents into knowledge networks.
...
* [git-pushing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/git-pushing) ⭐ 679 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Automate git operations and repository interactions.
* [review-implementing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/review-implementing) ⭐ 679 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Evaluate code implementation plans and align with specs.
* [test-fixing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/test-fixing) ⭐ 679 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Detect failing tests and propose patches or fixes.

### Security & Systems

* [computer-forensics](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/computer-forensics) ⭐ 679 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Digital forensics analysis and investigation techniques.
* [file-deletion](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/file-deletion) ⭐ 679 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Secure file deletion and data sanitization methods.
* [metadata-extraction](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/metadata-extraction) ⭐ 679 | 🐛 7 | 🌐 HTML | 📅 2026-07-25 - Extract and analyze file metadata for forensic purposes.
...
* [dev-gtm-claude-skills](https://github.com/Infrasity-Labs/dev-gtm-claude-skills) ⭐ 130 | 🐛 0 | 🌐 Python | 📅 2026-06-28 - Open-source, cross-platform agent skills for Claude Code and agentskills.io-compatible platforms. These skills are for SEO, GEO (Generative Engine Optimization), AI discoverability, and developer marketing.
...
* [Anthropic Skills Repository](https://github.com/anthropics/skills) ⭐ 178,537 | 🐛 1,330 | 🌐 Python | 📅 2026-09-24 - Official example skills
